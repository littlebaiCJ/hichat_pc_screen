...
function ws_brick(t, e, a){
        ...
        for(var r in t)(function(t, r){
            wowAnimate(function(e){
                ...
                for(var l in r[t].animate[.5 >= e ? "half" : "end"]){
                    var f = r[t].animate[.5 >= e ? "begin" : "half"][l] || 0, h = r[t].animate[.5 >= e ? "half" : "end"][l] || 0;
                ...
                r[t].wrapper.css({transform : "translate3d(" + (s.left ? s.left : 0).toFixed(3) + "px," + (s.top ? s.top : 0).toFixed(3) + "px,0)"}), delete s.left, delete s.top, n && (s.transform = n), r[t].part.css(s)
            }, 0, 1, r[t].animate.duration, r[t].animate.delay, function(){a++, a == r.length && e && e()})
        })(r, t)
    }

    function n(e, r, n, s){
        var d = a.width(), l = a.height(), c = d / f, p = l / h, g = .4 * t.duration > 1e3 ? 1e3 : .4 * t.duration, u = .6 * t.duration, m = [0, 0];
        o(v, e, x[r], c, p), w.css({transformOrigin : d / 2 + "px " + l / 2 + "px 0", width : d, height : l});
        for(var b in e){
            var k = T[b].delay * g;
    ...
    function s(t, e){
        e = e || {};
        {
            var a, r = 1, o = e.exclude || [], i = document.createElement("canvas"), n = i.getContext("2d");
    ...
    for(var Y = 0; f * h > Y; Y++){
        var X = Y % f, I = Math.floor(Y / f), _ = d("<div>").css({
            position : "absolute",
            left : 100 * X / f + "%",
            top : 100 * I / h + "%",
        ...
        }).appendTo(w), S = d("<div>").css({
            transform : "scale(1) rotateX(0) rotateY(0) translate3d(0,0,0)",
            outline : "1px solid transparent",
            transformStyle : "preserve-3d"
        }).appendTo(_), L = d("<div>").addClass("ws_front_image").appendTo(S), z = b ? d("<div>").addClass("ws_back_image").appendTo(S) : 0;
        L.css({
            position : "absolute",
            width : "100%",
            height : "100%",
    ...
    this.go = function(o, i){
        function s(t, e){return Math.random() * (e - t + 1) + t}
        ...
        if(g = {
            ...
            m[0].front.find("img").on("load", function(){u.hide()});
            ...
            x[i] || (x[i] = r(i)), Z = new n(m, i, g, function(){
                ...
                for(var t in m)m[t].part.css({transition : "", transform : "rotateX(0) rotateY(0) translate3d(0,0,0)"});
                Z = 0
            })
        } else {
            Z = !0;
            var y = a.width(), k = a.height(), T = y / f, Y = k / h;
            w.css({width : y, height : k});
            var X = 0;
            for(var v in m){
                var I = v % f, _ = Math.floor(v / f);
                m[v].front.find("img").attr("src", e.get(o).src).css(g);
                var S = t.duration * (1 - Math.abs((p * c - I * _) / (2 * h * f))), L = s(-1, 1) > 0 ? 1 : -1, z = s(-1, 1) > 0 ? 1 : -1;
                m[v].wrapper.css({width : T, height : Y}), m[v].part.css({
                    position : "absolute",
                    top : L * Y,
                    left : z * T,
                    opacity : 0,
                    ...
                    left : 0,
                    opacity : 1
                }, S, function(){X++, X == h * f && (u.stop(1, 1), Z = !1, l.trigger("effectEnd"))})
            }
        }
    }
}
jQuery.extend(jQuery.easing, {
    easeInBack : function(t, e, a, r, o, i){return void 0 == i && (i = 1.70158), r * (e /= o) * e * ((i + 1) * e - i) + a},
    easeOutBack : function(t, e, a, r, o, i){return void 0 == i && (i = 1.70158), r * ((e = e / o - 1) * e * ((i + 1) * e + i) + 1) + a},
